...
must_haves:
  truths:
    ...
    - "The orb animates between states: idle pulse, thinking spin, streaming open, error flash"
...
**Click handler** — On click, toggle between 'idle' and 'expanded'. If in 'error' state, clicking resets to 'idle'.
