/* @ts-self-types="./binderos_core.d.ts" */
...
export class BinderCore {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        BinderCoreFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_bindercore_free(ptr, 0);
    }
    /**
     ...
     * Output: EntropyScore
     * @param {any} atoms_js
     * @param {number} inbox_count
     * @param {number} inbox_cap
     * @param {number} task_cap
     * @param {number} now_ms
     * @returns {any}
     */
    compute_entropy(atoms_js, inbox_count, inbox_cap, task_cap, now_ms) {
        const ret = wasm.bindercore_compute_entropy(this.__wbg_ptr, atoms_js, inbox_count, inbox_cap, task_cap, now_ms);
        if (ret[2]) {
     ...
     * @returns {any}
     */
    compute_scores(atoms_js, now_ms) {
        const ret = wasm.bindercore_compute_scores(this.__wbg_ptr, atoms_js, now_ms);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    filter_compression_candidates(atoms_js, now_ms) {
        const ret = wasm.bindercore_filter_compression_candidates(this.__wbg_ptr, atoms_js, now_ms);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    constructor() {
        const ret = wasm.bindercore_new();
        this.__wbg_ptr = ret >>> 0;
        BinderCoreFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    ping() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.bindercore_ping(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    version() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.bindercore_version(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
if (Symbol.dispose) BinderCore.prototype[Symbol.dispose] = BinderCore.prototype.free;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./binderos_core_bg.js": import0,
    };
}

const BinderCoreFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_bindercore_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('binderos_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
